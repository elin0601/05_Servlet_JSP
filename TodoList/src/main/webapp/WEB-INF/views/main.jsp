...
<%-- JSTL 라이브러리를 현재 JSP에서 사용 하겠다는 JSP 지시자 작성 --%>
...
<body>
	...
	<!-- JSP 에서 Java(EL, JSTL), Front(HTML, CSS, JS) 중 
		 Jsva가 해석 우선 순위가 높다!! (먼저 해석 된다!!)
	 -->
	
	<c:if test="${not empty sessionScope.message}"> <!-- sessionScope에 message 속성이 있다면 -->
		<script>
			// EL을 이용해서 String 을 출력할 때 꼭 양쪽에 "" 추가 하기!!!!!!!!
			const message = "${message}"
			alert(message);		
		</script>
		
		<%-- sessionScpoe.message를 한 번만 출력한 후 제거하기 --%>
